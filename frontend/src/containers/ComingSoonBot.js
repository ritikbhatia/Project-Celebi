...
import './ComingSoonBot.css'


class ComingSoonBot extends React.Component {
    constructor(props){
        super(props);
      ...
      return (
        <div>
          ...
          <div className="wip-info">
            <p>Till then, feel free to play with Sustainabot. It will follow your mouse, show him around!</p>
          </div>
